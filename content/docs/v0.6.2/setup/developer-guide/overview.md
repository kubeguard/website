...
> New to Guard? Please start [here](/docs/v0.6.2/concepts/README).
...
#### Build Docker images
To build and push your custom Docker image, follow the steps below. To release a new version of Guard, please follow the [release guide](/docs/v0.6.2/setup/developer-guide/release).
