...
> New to Guard? Please start [here](/docs/v0.5.0-rc.0/concepts/README).
...
#### Build Docker images
To build and push your custom Docker image, follow the steps below. To release a new version of Guard, please follow the [release guide](/docs/v0.5.0-rc.0/setup/developer-guide/release).
