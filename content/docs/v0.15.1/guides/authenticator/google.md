...
## Deploy Guard Server
For detailed instructions follow the guide [here](/docs/v0.15.1/setup/install). To generate correct installer YAMLs for Guard server, pass the flags `--google.admin-email` and `--google.sa-json-file`.
...
![google-webhook-flow](/docs/v0.15.1/images/google-webhook-flow.png)
```json
{
