...
url: /docs/v0.8.1/welcome/contributing/
aliases:
- /docs/v0.8.1/CONTRIBUTING/
info:
  version: v0.8.1
---
...
We have a [Developer Guide](/docs/v0.8.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
