...
## Deploy Guard Server
For detailed instructions follow the guide [here](/docs/0.1.2/setup/install). To generate correct installer YAMLs for Guard server, pass the flags `--google.admin-email` and `--google.sa-json-file`.
...
![google-webhook-flow](/docs/0.1.2/images/google-webhook-flow.png)
```json
{
