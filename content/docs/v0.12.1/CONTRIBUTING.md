...
url: /docs/v0.12.1/welcome/contributing/
aliases:
- /docs/v0.12.1/CONTRIBUTING/
info:
  version: v0.12.1
---
...
We have a [Developer Guide](/docs/v0.12.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
