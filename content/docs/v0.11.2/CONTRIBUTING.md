...
url: /docs/v0.11.2/welcome/contributing/
aliases:
- /docs/v0.11.2/CONTRIBUTING/
info:
  version: v0.11.2
---
...
We have a [Developer Guide](/docs/v0.11.2/setup/developer-guide/overview) that outlines everything you need to know from setting up your
