...
url: /docs/v0.16.1/welcome/contributing/
aliases:
- /docs/v0.16.1/CONTRIBUTING/
info:
  version: v0.16.1
---
...
We have a [Developer Guide](/docs/v0.16.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
