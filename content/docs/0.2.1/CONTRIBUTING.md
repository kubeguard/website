...
url: /docs/0.2.1/welcome/contributing/
aliases:
- /docs/0.2.1/CONTRIBUTING/
info:
  version: 0.2.1
---
...
We have a [Developer Guide](/docs/0.2.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
